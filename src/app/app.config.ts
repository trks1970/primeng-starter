...
import { ROUTE_BASE_FORBIDDEN } from './features/base/base.routes'
...
export function MSALInterceptorConfigFactory(securityConfigService: SecurityConfigService): MsalInterceptorConfiguration {
...
export function MSALGuardConfigFactory(): MsalGuardConfiguration {
  return {
    interactionType: InteractionType.Redirect,
    authRequest: {},
    loginFailedRoute: '/' + ROUTE_BASE_FORBIDDEN
  }
}

export function BaseURLFactory(securityConfigService: SecurityConfigService): string {
  return securityConfigService.securityConfig.baseUrl
}
